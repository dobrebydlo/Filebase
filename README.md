...
**This is a fork of original [Filebase](https://github.com/filebase/Filebase) modified to suit my own needs**

A Simple but Powerful Flat File Database Storage. No need for MySQL or an expensive SQL server, in fact, you just need your current site or application setup. All database entries are stored in files ([formatted](https://github.com/dobrebydlo/ffdb#2-formatting) the way you like).
...
* [Querying data](https://github.com/dobrebydlo/ffdb#8-queries)
* [Custom filters](https://github.com/dobrebydlo/ffdb#7-custom-filters)
* [Caching](https://github.com/dobrebydlo/ffdb#9-caching) (queries)
* [Database Backups](https://github.com/dobrebydlo/ffdb#10-database-backups)
* [Formatting](https://github.com/dobrebydlo/ffdb#2-formatting) (encode/decode)
* [Validation](https://github.com/dobrebydlo/ffdb#6-validation-optional) (on save)
* CRUD (method APIs)
...
Run `composer require dobrebydlo/ffdb:^1.0`
...
|`validate`			|array		|   |Check [Validation Rules](https://github.com/dobrebydlo/ffdb#6-validation-optional) for more details |
|`cache`			|bool		|true   |Stores [query](https://github.com/dobrebydlo/ffdb#8-queries) results into cache for faster loading.				|
...
|`filter()`                       | Refer to the [Custom Filters](https://github.com/dobrebydlo/ffdb#7-custom-filters) |
...
|`get($id)`                       | Refer to [get()](https://github.com/dobrebydlo/ffdb#3-get-and-methods) |
...
|`query()`                        | Refer to the [Queries](https://github.com/dobrebydlo/ffdb#8-queries) |
|`backup()`                       | Refer to the [Backups](https://github.com/dobrebydlo/ffdb#10-database-backups) |
